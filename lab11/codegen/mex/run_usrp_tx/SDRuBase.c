...
comm_SDRuTransmitter *SDRuBase_SDRuBase(const emlrtStack *sp,
  comm_SDRuTransmitter *obj)
{
  ...
  const mxArray *b_y;
  const mxArray *m5;
  static const int32_T iv5[2] = { 1, 126 };
  ...
  for (i0 = 0; i0 < 10; i0++) {
    ...
    if (u < 0.0) {
      b_obj->ObjectID[i0 + 5] = (int8_T)-(int8_T)(uint8_T)-u;
    } else {
      b_obj->ObjectID[i0 + 5] = (int8_T)(uint8_T)u;
    }
  }
  ...
  for (k = 0; k <= i0 - 2; k++) {
    ...
    i1 = k + 2;
    if (i1 > loc_size_idx_1) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, loc_size_idx_1, &emlrtBCI, &d_st);
    }

    if (loc_data[idx - 1] != loc_data[i1 - 1] - 1) {
      idx = 1 + k;
      if (idx > loc_size_idx_1) {
        emlrtDynamicBoundsCheckR2012b(idx, 1, loc_size_idx_1, &emlrtBCI, &d_st);
      }
      ...
      if (idx > i1) {
        ...
        idx--;
        if ((i1 < 1) || (i1 > 25)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, 25, &b_emlrtBCI, &d_st);
        }
      }
  ...
  d_st.site = &n_emlrtRSI;
  b_obj->InterpolationFactor = 20.0;
  d_st.site = &n_emlrtRSI;
  e_st.site = &e_emlrtRSI;
  d_st.site = &n_emlrtRSI;
  b_obj->Gain = 15.0;
