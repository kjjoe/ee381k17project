 ...
 *
 * Code generation for function 'run_usrp_tx_initialize'
 *
 */
...
static void run_usrp_tx_once(void);
...
void run_usrp_tx_initialize(void)
{
...
/* End of code generation (run_usrp_tx_initialize.c) */
