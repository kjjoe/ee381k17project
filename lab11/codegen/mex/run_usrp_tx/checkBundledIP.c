                    ...
                    ipWrongPlatform_size[2])
{
  ...
  while ((!exitg1) && (i <= loc_size_idx_1 - 2)) {
    i8 = 1 + i;
    if ((i8 < 1) || (i8 > loc_size_idx_1)) {
      emlrtDynamicBoundsCheckR2012b(i8, 1, loc_size_idx_1, &o_emlrtBCI, sp);
    }
    ...
    guard1 = false;
    if (loc_data[i8 - 1] != loc_data[match_idx - 1] - 1) {
      i8 = 1 + i;
      if ((i8 < 1) || (i8 > loc_size_idx_1)) {
        emlrtDynamicBoundsCheckR2012b(i8, 1, loc_size_idx_1, &k_emlrtBCI, sp);
      }

      i8 = i + 2;
      if ((i8 < 1) || (i8 > loc_size_idx_1)) {
        emlrtDynamicBoundsCheckR2012b(i8, 1, loc_size_idx_1, &l_emlrtBCI, sp);
      }
      ...
      if (i8 > match_idx) {
        ...
        if ((i8 < 1) || (i8 > 25)) {
          emlrtDynamicBoundsCheckR2012b(i8, 1, 25, &m_emlrtBCI, sp);
        }
      ...
      if ((radiolist_size[1] == 0) || (ipAddr_size_tmp == 0)) {
        ...
        match_idx = 0;
        i8 = radiolist_size[1] - ipAddr_size_tmp;
      ...
      if (match_idx == 0) {
        ...
        for (i8 = 0; i8 < 5; i8++) {
          ...
          radiolist[i8] = radiolist_data[match_idx - 1];
        }
