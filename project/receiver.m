...
h_est(:,:,1) = ...
  [-0.0004 - 0.0074i,   0.0008 - 0.0050i; ...
   0.0096 - 0.0180i,   0.0008 - 0.0027i];


h_est(:,:,2) = ...
  [-0.0082 + 0.0045i,   0.0031 - 0.0021i; ...
  -0.0082 - 0.0009i,   0.0085 + 0.0006i];


h_est(:,:,3) = ...
  [-0.0052 + 0.0043i,   0.0015 - 0.0006i; ...
  -0.0083 + 0.0024i,   0.0051 + 0.0090i];


h_est(:,:,4) = ...
  [-0.0007 + 0.0082i,   0.0035 - 0.0008i; ...
  -0.0101 + 0.0294i,   0.0117 + 0.0040i];
%channel_tap = h_est;
...
var_noise_measured1 = 3.7229e-07; % You need to change this to what you estimate
var_noise_measured2 = 5.9392e-07; % You need to change this to what you estimate
snr1 = 10*log10((var_signal1-var_noise_measured1)/var_noise_measured1);
snr2 = 10*log10((var_signal2-var_noise_measured2)/var_noise_measured2);       
