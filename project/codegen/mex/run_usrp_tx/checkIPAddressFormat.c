...
static emlrtRTEInfo c_emlrtRTEI = { 387,/* lineNo */
  1,                                   /* colNo */
  "find",                              /* fName */
...
static emlrtRTEInfo d_emlrtRTEI = { 35,/* lineNo */
  3,                                   /* colNo */
  "checkIPAddressFormat",              /* fName */
  "/Users/kj23458/Documents/MATLAB/SupportPackages/R2018b/toolbox/shared/sdr/sdru/checkIPAddressFormat.m"/* pName */
};

static emlrtRTEInfo e_emlrtRTEI = { 54,/* lineNo */
  3,                                   /* colNo */
  "checkIPAddressFormat",              /* fName */
  "/Users/kj23458/Documents/MATLAB/SupportPackages/R2018b/toolbox/shared/sdr/sdru/checkIPAddressFormat.m"/* pName */
};
  ...
  int32_T x_size[2])
{
  ...
  if (x_size[1] == 0) {
    ...
    for (i6 = 0; i6 < loop_ub_tmp; i6++) {
      tmp_data[i6] = (x_data[i6] <= 57);
    }

    loop_ub_tmp = x_size[1] - 1;
    for (i6 = 0; i6 <= loop_ub_tmp; i6++) {
      b_x_data[i6] = ((!b_x_data[i6]) || (!tmp_data[i6]));
    }
  ...
  const int32_T aAddrs_size[2])
{
  ...
  if (i2 > i3) {
    ...
    if ((i2 < 1) || (i2 > aAddrs_size[1])) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, aAddrs_size[1], &f_emlrtBCI, sp);
    }

    i2--;
    if ((i3 < 1) || (i3 > aAddrs_size[1])) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, aAddrs_size[1], &e_emlrtBCI, sp);
    }
  }
  ...
  if (i4 > aAddrs_size[1]) {
    ...
    if ((i4 < 1) || (i4 > aAddrs_size[1])) {
      emlrtDynamicBoundsCheckR2012b(i4, 1, aAddrs_size[1], &d_emlrtBCI, sp);
    }
  ...
  d_aAddrs_size[1] = nx;
  for (ii_size_idx_1 = 0; ii_size_idx_1 < nx; ii_size_idx_1++) {
    b_aAddrs_data[ii_size_idx_1] = (uint8_T)aAddrs_data[i2 + ii_size_idx_1];
  }
  ...
  e_aAddrs_size[1] = nx;
  for (ii_size_idx_1 = 0; ii_size_idx_1 < nx; ii_size_idx_1++) {
    c_aAddrs_data[ii_size_idx_1] = (uint8_T)aAddrs_data[i4 + ii_size_idx_1];
  }
