CC="/usr/bin/xcrun -sdk macosx10.14 clang"
                ...
                LDFLAGS="-Wl,-twolevel_namespace -undefined error -arch x86_64 -mmacosx-version-min=10.9 -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk -bundle  -Wl,-exported_symbols_list,"/Applications/MATLAB_R2018a.app/extern/lib/maci64/mexFunction.map" -L"/Applications/MATLAB_R2018a.app/bin/maci64" -lmx -lmex -lmat -lc++ -Wl,-exported_symbols_list,"/Applications/MATLAB_R2018a.app/extern/lib/maci64/mexFunction.map""
                LDDEBUGFLAGS="-g"
