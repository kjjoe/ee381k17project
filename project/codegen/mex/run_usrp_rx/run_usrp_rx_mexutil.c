...
void d_error(const emlrtStack *sp, const mxArray *b, const mxArray *c,
...
{
  const mxArray *m27;
  return emlrtCallMATLABR2012b(sp, 1, &m27, 0, NULL, "sdruroot", true, location);
}
...
/* End of code generation (run_usrp_rx_mexutil.c) */
