  ...
  mxArray *c, const mxArray *d, emlrtMCInfo *location)
{
  ...
  pArrays[1] = c;
  pArrays[2] = d;
  return emlrtCallMATLABR2012b(sp, 1, &m28, 3, pArrays, "feval", true, location);
}
             ...
             varargin_1_size[2])
{
  ...
  const mxArray *c_y;
  const mxArray *m12;
  static const int32_T iv13[2] = { 1, 31 };
  ...
  st.tls = sp->tls;
  y = NULL;
  m10 = emlrtCreateCharArray(2, iv11);
  emlrtInitCharArrayR2013a(sp, 7, m10, &u[0]);
  emlrtAssign(&y, m10);
  b_y = NULL;
  m11 = emlrtCreateCharArray(2, iv12);
  emlrtInitCharArrayR2013a(sp, 7, m11, &b_u[0]);
  emlrtAssign(&b_y, m11);
  c_y = NULL;
  m12 = emlrtCreateCharArray(2, iv13);
